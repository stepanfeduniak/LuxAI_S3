...
def play_tournament(agent_1_cls, agent_2_cls,replay=True, tournament_rounds=1000, replay_save_dir="./trained_replays"):
    os.makedirs(replay_save_dir, exist_ok=True)
    agents={"agent_v1":agent_1_cls,"agent_v2":agent_2_cls}
...
if __name__ == "__main__":
    play_tournament(Agent_0,Agent, replay=True, tournament_rounds=20)